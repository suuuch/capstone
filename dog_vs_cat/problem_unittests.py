...
def test_folder_path(dog_vs_cat_dataset_folder_path):
    assert dog_vs_cat_dataset_folder_path is not None,\
        'Cifar-10 data folder not set.'
    assert dog_vs_cat_dataset_folder_path[-1] != '/',\
        'The "/" shouldn\'t be added to the end of the path.'
    assert os.path.exists(dog_vs_cat_dataset_folder_path),\
        'Path not found.'
    assert os.path.isdir(dog_vs_cat_dataset_folder_path),\
        '{} is not a folder.'.format(os.path.basename(dog_vs_cat_dataset_folder_path))
